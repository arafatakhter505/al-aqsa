...
const AttendanceTable = ({ data, filter, refetch, isLoading }) => {
  const { user } = useContext(AuthContext);
  const { attendances, pagination } = data;
  const { search, setSearch, date, setDate, setPage, limit, setLimit } = filter;
  ...
  return (
    <div className="bg-white p-5 mb-6 rounded-md shadow">
      <div className="flex items-center justify-between gap-5 md:flex-row flex-col">
        <div className="lg:w-3/4 md:w-2/5 w-full flex items-center justify-between gap-5">
