...
import BatchDetailsTableRow from "./BatchDetailsTableRow";

const BatchDetailsTable = ({ data, filter, refetch, isLoading }) => {
            ...
            <table className="min-w-max w-full table-auto">
              <thead>
                <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                  ...
                  <th className="py-3 px-6 text-center">Batch Name</th>
